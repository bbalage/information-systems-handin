...
export class removeBorrowableItem1618755777977 implements MigrationInterface {
    name = 'removeBorrowableItem1618755777977'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `borrow` (`borrowId` int NOT NULL AUTO_INCREMENT, `dateOfBorrow` date NOT NULL, `memberId` int NULL, `borrowableSerialNumber` int NULL, PRIMARY KEY (`borrowId`)) ENGINE=InnoDB");
